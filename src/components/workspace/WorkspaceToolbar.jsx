...
/**
 * Compact canvas toolbar: selection, dimension, history, save, clear.
 * Sketch primitives and relations live in the sidebar Drawing tab.
 */
export function WorkspaceToolbar({
  ...
  return (
    <div className="flex min-w-0 flex-wrap items-center gap-0.5 rounded-lg border border-gg-border bg-gg-sidebar/40 p-1">
      <button
        type="button"
